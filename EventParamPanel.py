...
class EventParamPanel(wx.Panel):
    ...
    def __do_layout(self):
        ...
        sizer_trig_th.Add(self.lbl_trig_th, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_trig_th.Add(self.txt_trig_th, 1, wx.EXPAND, 0)

        sizer_trig_dt = wx.BoxSizer(wx.HORIZONTAL)
        sizer_trig_dt.Add(self.lbl_trig_dt, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_trig_dt.Add(self.txt_trig_dt, 1, wx.EXPAND, 0)

        sizer_trig_dl = wx.BoxSizer(wx.HORIZONTAL)
        sizer_trig_dl.Add(self.lbl_trig_dl, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_trig_dl.Add(self.txt_trig_dl, 1, wx.EXPAND, 0)

        sizer_evt_len = wx.BoxSizer(wx.HORIZONTAL)
        sizer_evt_len.Add(self.lbl_evt_len, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_evt_len.Add(self.txt_evt_len, 1, wx.EXPAND, 0)

        sizer_evt_tail = wx.BoxSizer(wx.HORIZONTAL)
        sizer_evt_tail.Add(self.lbl_evt_tail, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_evt_tail.Add(self.txt_evt_tail, 1, wx.EXPAND, 0)

        sizer_bl_len = wx.BoxSizer(wx.HORIZONTAL)
        sizer_bl_len.Add(self.lbl_bl_len, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
        ...
        sizer_main.Add(sizer_evt_len, 0, wx.EXPAND, 0)
        sizer_main.Add(sizer_evt_tail, 0, wx.EXPAND, 0)
