...
class ModePanel(wx.Panel):
    ...
    def __do_layout(self):
        ...
        sizer_run.Add(self.lbl_run, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_run.Add(self.chk_run, 1, wx.EXPAND)

        sizer_ext_trig = wx.BoxSizer(wx.HORIZONTAL)
        sizer_ext_trig.Add(self.lbl_ext_trig, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_ext_trig.Add(self.chk_ext_trig, 1, wx.EXPAND)

        sizer_self_trig = wx.BoxSizer(wx.HORIZONTAL)
        sizer_self_trig.Add(self.lbl_self_trig, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_self_trig.Add(self.chk_self_trig, 1, wx.EXPAND)

        sizer_int_trig = wx.BoxSizer(wx.HORIZONTAL)
        sizer_int_trig.Add(self.lbl_int_trig, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_int_trig.Add(self.chk_int_trig, 1, wx.EXPAND)

        sizer_ena_trig_out = wx.BoxSizer(wx.HORIZONTAL)
        sizer_ena_trig_out.Add(self.lbl_ena_trig_out, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_ena_trig_out.Add(self.chk_ena_trig_out, 1, wx.EXPAND)

        sizer_ena_temp_rd = wx.BoxSizer(wx.HORIZONTAL)
        sizer_ena_temp_rd.Add(self.lbl_ena_temp_rd, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_ena_temp_rd.Add(self.chk_ena_temp_rd, 1, wx.EXPAND)

        sizer_bypass_blr = wx.BoxSizer(wx.HORIZONTAL)
        sizer_bypass_blr.Add(self.lbl_bypass_blr, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_bypass_blr.Add(self.chk_bypass_blr, 1, wx.EXPAND)

        sizer_raw_adc_rd = wx.BoxSizer(wx.HORIZONTAL)
        sizer_raw_adc_rd.Add(self.lbl_raw_adc_rd, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        ...
        sizer_afe_cal.Add(self.chk_afe_cal, 1, wx.EXPAND)

        sizer_onfly_cal = wx.BoxSizer(wx.HORIZONTAL)
        sizer_onfly_cal.Add(self.lbl_onfly_cal, 1, wx.ALL | wx.ALIGN_CENTER, 4)
        sizer_onfly_cal.Add(self.chk_onfly_cal, 1, wx.EXPAND)

        sizer_mode_box.Add(self.btn_update_mode, 0, wx.EXPAND, 0)
