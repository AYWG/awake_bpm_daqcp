...
class ModePanel(wx.Panel):
    ...
    def __do_layout(self):
        ...
        sizer_run.Add(self.chk_run, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_ext_trig.Add(self.chk_ext_trig, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_self_trig.Add(self.chk_self_trig, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_int_trig.Add(self.chk_int_trig, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_ena_trig_out.Add(self.chk_ena_trig_out, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_ena_temp_rd.Add(self.chk_ena_temp_rd, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_bypass_blr.Add(self.chk_bypass_blr, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_raw_adc_rd.Add(self.chk_raw_adc_rd, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)

        sizer_blr_rd = wx.BoxSizer(wx.HORIZONTAL)
        sizer_blr_rd.Add(self.lbl_blr_rd, 1, ((wx.LEFT | wx.RIGHT) | wx.EXPAND), SIZER_BORDER_WIDTH)
        sizer_blr_rd.Add(self.chk_blr_rd, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_afe_cal.Add(self.chk_afe_cal, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
        ...
        sizer_onfly_cal.Add(self.chk_onfly_cal, 0, ((wx.LEFT | wx.RIGHT) | wx.ALIGN_CENTER), SIZER_BORDER_WIDTH)
